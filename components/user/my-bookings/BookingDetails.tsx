...
const PastStatus = ({ favourite, setFavourite }: any) => {
    return (
...
const FavoriteStatus = ({ favourite, setFavourite }: any) => {
    return (
        ...
        <div className='pb-[50px]'>
            <Container >
                <div className='flex justify-between items-center bg-background sticky top-0 pt-[50px] pb-[30px]'>
                    ...
                    <FavoriteStatus favourite={favourite} setFavourite={setFavourite} />
                </div>
                <div className='grid lg:grid-cols-3 lg:grid-rows-1 grid-rows-3 gap-5'>
                    <div className='grid gap-2.5 max-lg:order-1'>
                        ...
                        <div className='bg-[#EBEBEB] dark:bg-[#1E1E1E] md:py-[22px] py-2.5 px-2.5 rounded-2xl flex gap-[10px] items-center md:h-[110px]'>
                            <Image alt="salonImage" width={80} height={65} src={'/assets/SalonImages.jpg'} className='!w-20 !h-[65px] object-cover object-center' />
                            <div className='grid gap-1.5'>
                                <h5 className='font-urbanist font-bold md:text-[20px] text-lg leading-[20px] tracking-[0] mb-0'>Coiffeur bei Yousef</h5>
                    ...
                    <div className='grid gap-2.5 max-lg:order-3'>
                        ...
                        <div className='lg:bg-[#EBEBEB] dark:lg:bg-[#1E1E1E] lg:py-[22px] px-2.5 rounded-2xl flex gap-[10px] items-center h-[110px]'>
                            <Image alt="salonImage" width={55} height={55} src={'/assets/joseph.jpg'} className='rounded-full object-center object-cover md:w-[55px] md:h-[55px] w-10 h-10' />
                            <div className='grid gap-1.5'>
                                <h5 className='font-urbanist font-bold md:text-[20px] text-[14px] leading-[20px] tracking-[0] mb-0'>Yousef</h5>
                            </div>
                        </div>
                    </div>
                    <div className='grid gap-2.5 max-lg:order-2'>
                        ...
                        <div className='lg:bg-[#EBEBEB] dark:lg:bg-[#1E1E1E] pl-[15px] py-[3.5px] pr-[3.5px] rounded-2xl flex gap-[10px] items-center h-[110px] justify-between'>
                            <div className='grid gap-2.5'>
                                <p className='flex items-center gap-1.5 font-urbanist font-semibold md:text-[18px] text-sm  leading-[130%] tracking-[0]'><span className='!text-[#FF8C26]'><CalendarIcon size={24} className="max-md:w-5" /></span> 7 May 2025</p>
                                <p className='flex items-center gap-1.5 font-urbanist font-semibold md:text-[18px] text-sm  leading-[130%] tracking-[0]'><span className='!text-[#FF8C26]'><ClockIcon size={24} className="max-md:w-5" /></span> 2:00 PM</p>
                            </div>
                            <div className='bg-[#583b20] h-full rounded-[12px] flex flex-col'>
                                ...
                                <div className='px-[26px] flex-1 flex items-center flex-col justify-center'>
                                    <h4 className='font-urbanist font-extrabold text-[42px] leading-[100%] tracking-[0] !text-white'>60</h4>
                ...
                <div className='w-full mt-5 mb-[200px]'>
                    ...
                    <div className='grid grid-cols-3 gap-x-[2.4px] gap-y-[1.6] rounded-2xl overflow-hidden max-md:hidden'>
                            ...
                            <>
                                <div key={i + 1} className='bg-[#EBEBEB] dark:bg-[#1E1E1E] font-urbanist font-semibold text-[20px] leading-[100%] tracking-[0] align-middle py-[11px] text-center flex justify-center items-center'>
                                    <div className='flex justify-center items-center gap-[15px]'>
                                        <Image alt="haircut image" width={60} height={60} src={'/assets/categoryImage.jpg'} className='rounded-[8px] object-cover object-center w-[77px] h-[75px]' />
                                        <h5 className='flex items-center gap-[5px] font-urbanist font-semibold text-[18px] leading-[130%] tracking-[0]'>Mullet Haircut<span><InfoCircleIcon /></span></h5>
                                    </div>
                                </div>
                                <div key={i + 2} className='bg-[#EBEBEB] dark:bg-[#1E1E1E] font-urbanist font-semibold text-[20px] leading-[100%] tracking-[0] align-middle py-[11px] text-center flex justify-center items-center'>452</div>
                                <div key={i + 3} className='bg-[#EBEBEB] dark:bg-[#1E1E1E] font-urbanist font-semibold text-[20px] leading-[100%] tracking-[0] align-middle py-[11px] text-center flex justify-center items-center'>€ 250</div>
                            </>
                        ))}
                        {/* footer */}
                        ...
                        <div className='bg-[#EBEBEB] dark:bg-[#1E1E1E] font-urbanist font-semibold text-[24px] leading-[100%] tracking-[0] align-middle py-[20.5px] text-center flex justify-center items-center !text-[#FF8C26]'>€ 250</div>
                    </div>
                    <div className='grid gap-2.5'>
            ...
            <div className='fixed bottom-0 max-md:bg-[#EBEBEB] max-md:dark:bg-[#1E1E1E] w-full max-md:rounded-t-[25px] max-md:pt-4'>
